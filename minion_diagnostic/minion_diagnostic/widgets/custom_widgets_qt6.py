...
class SmoothProgressBar(QProgressBar):
    def __init__(self, parent: QWidget | None = None, color="dodgerblue", choropleth=False, temp_range=(30.0, 80.0)):
        """A progressbar that moves smoothly instead of snapping.

        If choropleth is True, the color will be a gradient from green->red based on percent (0..100)
        """
        super().__init__()
        if parent:
